...
if __name__=='__main__':
    ...
    # Example task format
    curr_task = {
                    "task_instr": ["Cook the potato, put it into the fridge, go to the room and turn off the tv."],
                    ...
                    "vis_objs": ["tv", "microwave", "fridge", "garbagecan"], "completed_plans": [("Navigation", "Countertop"),("PickupObject", "Potato"), ("Navigation", "Microwave")]
                }
